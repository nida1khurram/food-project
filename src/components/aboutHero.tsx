...
export default function AboutHero() {
  ...
  <div className="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
    ...
    <Image 
        ...
        // className='relative'
        />
        <div className='absolute top-64 left-40 bg-[#474747] w-[411px] h-[321px] rounded-lg'>
    ...
    <div className="lg:flex-grow md:w-1/2 lg:pl-24 md:pl-16 flex flex-col md:items-start md:text-left items-center text-center">
      <h1 className="playfair-display-sc-black-italic title-font sm:text-4xl text-9xl mb-4 font-medium text-gray-900">
       We provide healthy
      ...
      {/* <Image 
        alt='about-hero'
        src={require('../../public/picture/about/bg.png')}
        width={411}
        height={321}
        // className='box my-[100]'
        /> */}
{/* <div className='aboutHeroBox'>Hi</div> */}
